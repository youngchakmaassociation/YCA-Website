    ...
    return (
        <div className="fixed bottom-6 right-6 z-50">
            ...
            >
                ...
                {/* Tooltip */}
                {!isOpen && (
                    <div className="absolute right-16 bg-black/80 text-white text-[10px] px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        Need help? Ask AI
                    </div>
                )}
            </button>
