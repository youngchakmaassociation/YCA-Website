...
export default function SakeiluiZonePage() {
    const [branches, setBranches] = useState([]);
    const [leaders, setLeaders] = useState([]);
    const [loading, setLoading] = useState(true);

    const FALLBACK_LEADERS = [
        { name: 'Mr. Sakeilui President', designation: 'President', photo_url: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBCG-0zhTlsBim89w7wgunF5cbzUzkruaXWK-o0B6gwK4o6IqnJdu2QpFumGraV5yzxVTK0gNOwz2TF5w8dHyJN0sFaILq1gqmtE4uKlbElw10AmnMeII3jUfQKsKqeg5XkksB6Ov7dQkM6HxO4O16dwu1XzlddK10_Y_Htn5ZHHizivJ21vN-UuZttm6ytEm3p1MkKSYYfPE_6_xcN_eYp8ttT9M9IO5ZZMXwFMAUCO8ugfsYuYPOSuM9dJIKObXNGkYjMx5mgROxc' },
        ...
        const fetchData = async () => {
            try {
                ...
                if (cRes.success && cRes.data) {
                    const zonalLeaders = cRes.data.filter(l => l.level === 'zonal');
        ...
        <div className="container mx-auto px-4 py-8 md:py-16">
            <div className="flex flex-col items-center text-center gap-6 mb-24 animate-fade-in-up">
                ...
                <h1 className="text-5xl md:text-8xl font-black text-primary leading-tight">
                    Sakeilui <br /> <span className="text-accent underline decoration-primary decoration-8 underline-offset-12">Zone</span>
                </h1>
                <div className="flex flex-col items-center gap-2">
                    <p className="max-w-2xl text-xl font-medium opacity-80 leading-relaxed italic text-primary">
                        "Proudly known as Bageisury by our community"
                    </p>
                    <p className="max-w-2xl text-sm font-bold opacity-40 uppercase tracking-widest">
                        Government Designation: Sakeilui
                    </p>
                </div>
                <p className="max-w-2xl text-xl font-medium opacity-60 leading-relaxed mt-4">
                    The administrative heart of Chakma youth operations across the Sakeilui region.
                    While officially recognized as Sakeilui, this land is cherished as Bageisury by its people,
                    representing our local heritage and coordination for national impact.
                </p>
            </div>
